...
Именно на такого рода сервисы у меня и направлен данный сервис-прокси, в дальнейшем я реализую на выбор либо веб-проект, либо приложение, в котором вы сможете загружать и читать свои любимые книги и т.п без каких либо задержек, зависаний сайтов, и долгой загрузкой страниц, чтобы дать вам возможность максимально эффективно распоряжаться вашим временем, которое вы уделяете на свое любимое дело.
